...
def get_ind_file(filetype):
    ...
    ind = pd.read_csv(f"https://raw.githubusercontent.com/Redzoro1993/Introduction-to-Portfolio-Construction-and-Analysis-with-Python/master/Data/ind30_m_{name}.csv", header=0, index_col=0)/divisor
